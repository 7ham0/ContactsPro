...
//        let items: [(name: String, phone: String, mail: String)] = parseCsvString(csvString: str!)
//
//        let context = (UIApplication.shared.delegate as! AppDelegate).persistentContainer.viewContext
//
//        for item in items {
//            print(item.name + " " + item.phone + item.mail)
//
//            let contact = Contact(context: context)
//            contact.name = item.name
//            contact.phone = item.phone
//            contact.profile = #imageLiteral(resourceName: "default").pngData()
//            contact.mail = item.mail
//
//            self.saveContext()
//        }
//    }
...
//            let items: [(String, String, String)] = self.parseCsvString(csvString: str)
//
//            for item in items {
//                print(item.0)
//            }
